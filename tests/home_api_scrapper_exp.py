...
api_db_path = cwd + "/tests/dbs/homes_by_city.db"
...
home_api_scrapper = HomeAPIScrapper(tmp_path, 'api', logs_tracker, city_tracker, url_tracker, redfin)
# home_api_scrapper.load()
home_api_scrapper.reload()